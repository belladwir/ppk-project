...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2019 at 07:06 AM
...
INSERT INTO `stgk_pemesanan` (`id_pemesanan`, `nama_pembeli`, `jumlah_orang`, `type`, `total_harga`, `tanggal`, `status`) VALUES
(4, 'bella', 2, 'Dine In', 0, '2019-09-26', 'proses'),
(5, 'tamara', 4, 'Take Away', 0, '2019-09-29', ''),
(6, 'adhitama', 2, 'Dine In', 0, '2019-09-29', ''),
(8, 'chandra', 3, 'Take Away', 0, '2019-10-02', ''),
(9, 'elfa', 2, 'Dine In', 0, '2019-10-02', ''),
(10, 'hima', 1, 'Take Away', 0, '2019-10-02', ''),
(11, 'Adhitama', 5, 'Dine In', 13000, '2019-10-03', 'selesai'),
(13, 'Tama', 1, 'Take Away', 33500, '2019-10-03', 'selesai'),
(15, 'Elfa', 1, 'Take Away', 29500, '2019-10-03', 'proses');
...
CREATE TABLE `stgk_sementara` (
  ...
  `total_pesan` double DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `stgk_sementara` (`id`, `id_pembeli`, `id_menu`, `jumlah`, `harga`, `total_pesan`) VALUES
(6, 4, 1, 3, 13000, 39000),
(7, 4, 2, 5, 15000, 75000),
(36, 13, 1, 2, 13000, 26000),
(37, 13, 5, 1, 7500, 7500),
(38, 11, 1, 1, 13000, 13000),
(40, 13, 4, 1, 5000, 5000),
(41, 13, 5, 1, 7500, 33500),
(45, 15, 5, 1, 7500, 7500),
(46, 15, 3, 2, 11000, 22000);
